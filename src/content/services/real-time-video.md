...
**Capabilities:**
- NDI and WebRTC video transport
- Sub-frame latency compositing and effects
- FFmpeg pipeline optimization for live workflows
- Interactive video mirrors with depth sensors
- Real-time virtual set compositing with Unreal Engine
- Live broadcast graphics and lower-thirds