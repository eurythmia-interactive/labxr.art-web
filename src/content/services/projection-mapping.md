...
**Capabilities:**
- Sub-millimeter photogrammetry + LiDAR 3D scanning
- Custom UV unwrapping for irregular surfaces
- Edge-blending across multi-projector arrays
- Real-time generative content with audio reactivity
- Disguise + MadMapper + TouchDesigner pipelines
- Outdoor weatherproofing and daytime visibility tuning